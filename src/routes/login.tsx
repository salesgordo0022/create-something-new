...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#faf8f3' }}>
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-full agro-gradient flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
            </div>
            <h1 className="text-2xl font-bold" style={{ color: '#1a5c2a' }}>Diagnóstico Tributário</h1>
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #1a5c2a 0%, #0d3b1a 100%)' }}>
        <div className="absolute inset-0 opacity-10">
          <div style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=60 height=60 viewBox=0 0 60 60 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg fill=%22none%22 fill-rule=%22evenodd%22%3E%3Cg fill=%22%23ffffff%22 fill-opacity=%221%22%3E%3Cpath d=%22M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} className="absolute inset-0" />
        </div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 text-center">
            {['Produtores', 'Diagnósticos', 'Relatórios'].map((item) => (
              <div key={item} className="bg-white/5 rounded-xl p-4">
                <div className="text-2xl font-bold text-white">{['320+', '280+', '150+'][['Produtores', 'Diagnósticos', 'Relatórios'].indexOf(item)]}</div>
